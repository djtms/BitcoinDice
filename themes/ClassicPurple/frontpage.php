    ...
    <div id="all" class="menu-line">
      <div id="content">
        ...
        <div class="menu">
          ...
          <a href="#" onclick="javascript:return account();">KONTO</a>
        </div>
      </div>
    </div>
         ...
         <div class="wrap">
          <div class="c_center">
              ...
              <div class="betTb">
                ...
                <div class="betTbC">
                  <small><small><b>MNOŻNIK</b></small></small><br>
                ...
                <div class="betTbR">
                  <small><small><b>SZANSA WYGRANEJ</b></small></small><br>
              ...
              <div class="betTb_s">
                <table width="95%" style="border-collapse: collapse;">
                  <tr>
                    ...
                    <td valign="top" style="padding-bottom: 4px;">
                      <div><small><b>PO WYGRANEJ</b></small></div>
                      <div>
                        <input id="bB_win_return" class="bB_checkbox" type="checkbox" checked="checked">
                        <label for="bB_win_return" class="bB_label"><small>Powrót do Bazowej</small></label>                
                      </div>
                      <div>
                  ...
                  <tr>
                    ...
                    <td valign="top" style="padding-top: 8px;">
                      <div style="margin-top: 2px;">
                        ...
                        <label for="bB_max_win" class="bB_label"><small>Max Zysk:</small></label><br>                
