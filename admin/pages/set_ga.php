...
?>
  <br>Zeskanuj ten kod QR w Authenticatorze:<br>
  <div class="tqrcode"></div>
  <script type="text/javascript">
    $(".tqrcode").qrcode("otpauth://totp/<?php echo $this_admin['username'].'@'.$settings['url'].'?secret='.$newtoken; ?>");
  </script>
  <br> lub wpisz ręcznie tajny klucz:<br>
  <b><?php echo $newtoken; ?></b>
  <br>
  <br>
  Wprowadź hasło jednorazowe wygenerowane przez Authenticator:
  <br>
  <input type="text" id="totp_test"><br>
  <button onclick="javascript:pair();">Authenticate</button>
<?php } else { ?>
  <br>Logowanie dwu etapowe jest <b>Aktywne</b> dla tego konta. <a href="./?p=set_ga&rem">Wyłączone</a>
<?php } ?>
